...
public class BoardRepositoryCustomImpl implements BoardRepositoryCustom {
    ...
    public BooleanBuilder getSearch(String searchConditon, String searchKeyword) {
        ...
        if(searchConditon.equalsIgnoreCase("all")) {
        ...
        } else if(searchConditon.equalsIgnoreCase("title")) {
            booleanBuilder.and(board.title.containsIgnoreCase(searchKeyword));
        } else if(searchConditon.equalsIgnoreCase("content")) {
            booleanBuilder.and(board.content.containsIgnoreCase(searchKeyword));
        } else if(searchConditon.equalsIgnoreCase("writer")) {
